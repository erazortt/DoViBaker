...
- `normalize` normalizes to output to `targetMaxNits`. This can be usefull when the further processing is needed, since the usage of the value range decreases rounding errors.
